...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 08, 2019 at 04:54 AM
...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `failed_tries` tinyint(4) NOT NULL,
  `last_failed_tries` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_ip`, `user_login`, `failed_tries`, `last_failed_tries`) VALUES
(1, '', 'admin', '123', '', '2019-01-25 20:50:05', 'no', '2019-02-07 22:30:47', 0, '2019-02-07 22:58:52');
COMMIT;
